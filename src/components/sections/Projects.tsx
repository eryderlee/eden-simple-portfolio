...
function YouTubeFacade({ youtubeId }: { youtubeId: string }) {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden">
      {/* Thumbnail stays mounted underneath the iframe so the user never
          sees YouTube's player UI flash (big play button, title, etc.) while
          the embed initialises and applies controls=0. */}
      <button
