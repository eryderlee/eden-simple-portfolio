...
const FEATURED_ITEMS: FeaturedItem[] = [
  ...
  },
  {
    ...
    labelColor: 'text-[#3b82f6]',
    name: 'R Dhillon & Co',
    description: 'Chartered accountants in the Hills District. Built end to end for local search: schema-marked service pages, transparent pricing, and contrast plus breadcrumb checks that gate every deploy.',
    tech: ['Astro', 'Cloudflare Pages', 'Playwright', 'Local SEO'],
    links: [{ label: 'View Site', url: 'https://dhillonco.com.au' }],
    status: 'LIVE SITE',
    statusColor: 'bg-[#22c55e]',
    aspectRatio: '16:9',
    mediaLabel: 'Autoplays when in view',
    mediaFile: 'dhillonco.com.au — full page capture',
    videoSrc: '/videos/featured/r-dhillon-co.mp4',
  },
  {
    id: 'F11',
    label: 'PRODUCT · AI SYSTEMS',
    labelColor: 'text-[#a855f7]',
    name: 'Vortex AI OS',
    description: 'An operating system I built for running AI coding agents: a live work board, scheduled agent loops, a manager that proposes changes for approval, and a hardened headless runner behind it. Shown here on demo data.',
    tech: ['React', 'TypeScript', 'Vite', 'Fastify', 'Claude Code'],
    links: [],
    ...
    aspectRatio: '16:9',
    mediaLabel: 'Autoplays when in view',
    mediaFile: 'vortex — panel tour, demo data',
    videoSrc: '/videos/featured/vortex-ai-os.mp4',
  },
];
